(function (window, document) {
  ...
  panel.innerHTML = [
    '<div class="coveragefit-invitation-status">',
      ...
      '<p>Your information is already submitted. The next step is entirely your choice.</p></div>',
    '</div>',
    ...
    '<div data-coveragefit-invitation-choice>',
      ...
      '<p class="coveragefit-invitation-intro">Choose the path that feels right. Your original request stays submitted either way.</p>',
      '<div class="coveragefit-invitation-options" role="group" aria-label="Choose what happens next">',
        ...
        '<article class="coveragefit-invitation-option coveragefit-invitation-option--followup">',
          ...
          '<h3>Have Dylan follow up</h3>',
          '<p>No additional questions right now. Dylan can contact you using the preference and details you already provided.</p>',
    ...
    '<div class="coveragefit-invitation-finished" data-coveragefit-invitation-finished hidden>',
      ...
      '<h2>Your request is with Dylan.</h2>',
      '<p>There is nothing else you need to complete right now. Dylan can follow up using the contact preference you provided.</p>',
