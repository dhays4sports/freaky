(function (window, document) {
  ...
  var fieldMap = Object.freeze({
    ...
    2: Object.freeze({ radio: 'engagement_housing_context', form: 'housing_context' }),
    3: Object.freeze({ radio: 'engagement_review_timing', form: 'review_timing' })
  });
  var progressLabel = root.querySelector('[data-home-progress-label]');
  var progressBar = root.querySelector('[data-home-progress-bar]');
  var live = root.querySelector('[data-home-engagement-live]');
  ...
  var PAYOFF_COPY = Object.freeze({
    goal: Object.freeze({
      farmers_fit: Object.freeze({
        title: 'Let\'s see whether Farmers may be worth comparing.',
        label: 'Farmers fit review',
        copy: 'Dylan will use your completed review to evaluate whether available Farmers options may align with your needs.'
      }),
      coverage_fit: Object.freeze({
        title: 'Let\'s check whether your protection still fits.',
        label: 'Current coverage fit',
        copy: 'Your review will organize the parts of your current protection that may deserve a closer look.'
      }),
    ...
    housing: Object.freeze({
      ...
      renter: Object.freeze({ label: 'Renters-specific review', copy: 'After your details, you will continue to a direct renters conversation with Dylan.' })
    }),
    timing: Object.freeze({
      shopping_now: Object.freeze({ label: 'Comparing now', copy: 'The review will help organize a near-term conversation with Dylan.' }),
      renewal_60: Object.freeze({ label: 'Renewal within 60 days', copy: 'Your upcoming renewal will stay visible throughout the review.' }),
      later: Object.freeze({ label: 'Planning ahead', copy: 'You can build clarity now and decide when you are ready to compare.' }),
      not_sure: Object.freeze({ label: 'Flexible timing', copy: 'Dylan can help you choose a practical next step after the review.' })
    })
  });
  ...
  function showPayoff() {
    ...
    var renter = semantic.housingContext === 'renter';
    setText('[data-home-payoff-next-copy]', renter
      ? 'Share your contact details so Dylan can follow up directly about renters options. You will not be sent into the homeowner assessment.'
      : 'Share your contact and property details, then CoverageFit will organize the protection questions worth reviewing with Dylan.');
    payoffContinue.querySelector('span').textContent = renter ? 'Continue to my renters review' : 'Continue to my details';
  ...
  function revealLeadForm() {
    ...
    announce('Quick questions complete. Enter your contact and property details to continue.');
