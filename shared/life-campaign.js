...
(function (window, document) {
  ...
  var VARIANTS = {
    before_anything_changes: {
      ...
      lead: 'Your age and health can affect what life insurance you qualify for and what it costs.',
      support: 'If life insurance has been sitting on your to-do list, getting started may be simpler than you expect.',
      cta: 'Get started'
    },
    '20_minutes': {
      code: 'B',
      titleHtml: '<span>20</span><br/>minutes.',
      titleText: '20 minutes.',
      lead: 'That is about how long it may take to complete your life insurance application.',
      support: 'You may spend longer tonight scrolling your phone. Start with three quick questions, then get your application ready.',
      cta: 'Start now'
    },
    this_is_the_time: {
      code: 'C',
      ...
      lead: 'While life is normal. While you have options.',
      support: 'Life insurance can be easier to put in place before a health or life change makes the decision more complicated.',
      cta: 'Get started'
    },
    financial_picture: {
      code: 'D',
