(function (window, document) {
  ...
  var LEAD_STATUS = Object.freeze({
    confirmed: Object.freeze({
      ...
      copy: 'Dylan has your contact and property details. Three quick answers will help shape the review around what matters to you.'
    }),
  ...
  panel.innerHTML = [
    '<div class="post-lead-receipt">',
      '<span class="post-lead-check" aria-hidden="true">✓</span>',
    ...
    '<div data-post-lead-question-stage>',
      ...
      '</div>',
      '<h2 id="post-lead-title">Help Dylan focus your review.</h2>',
      '<p class="post-lead-intro">Your request is already submitted. These answers shape the next step and do not submit another lead.</p>',
    ...
    '<div class="post-lead-payoff" data-post-lead-payoff hidden>',
      '<div class="post-lead-kicker">Your personalized next step</div>',
    ...
    '<div class="post-lead-finished" data-post-lead-finished hidden>',
      ...
      '<p>Dylan can follow up using the contact preference you provided. You can also reach him directly whenever you’re ready.</p>',
  ...
  panel.querySelector('[data-post-lead-later]').addEventListener('click', function () {
    ...
    live.textContent = 'Your request is complete. Dylan can follow up.';
