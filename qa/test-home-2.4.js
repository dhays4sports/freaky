...
check('review context remains visible without JS and derived when enhanced', home.includes('data-home-review-context') && !/data-home-review-context[^>]+hidden/.test(home) && styles.includes('.home-lead-progressive-active [data-home-review-context]'));
...
check('Formspree grace and zero-repeat handoff remain intact', submit.includes('Promise.race') && submit.includes('keepalive:true') && home.includes('data-cf-next="/assessment/"'));
